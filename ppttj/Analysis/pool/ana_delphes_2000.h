...
// Fri Feb 12 11:33:18 2016 by ROOT version 5.34/32
// from TTree Delphes/Analysis tree
// found on file: ../Events/run_ihtmin_20k_2000/tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef ana_delphes_2000_h
#define ana_delphes_2000_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   const Int_t kMaxParticle = 1712;
   const Int_t kMaxTrack = 278;
   const Int_t kMaxTower = 327;
   const Int_t kMaxEFlowTrack = 278;
   const Int_t kMaxEFlowPhoton = 197;
   const Int_t kMaxEFlowNeutralHadron = 114;
...
public :
   ...
   ana_delphes_2000(TTree *tree=0);
   virtual ~ana_delphes_2000();
...
#ifdef ana_delphes_2000_cxx
ana_delphes_2000::ana_delphes_2000(TTree *tree) : fChain(0) 
{
...
ana_delphes_2000::~ana_delphes_2000()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ana_delphes_2000::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ana_delphes_2000::LoadTree(Long64_t entry)
{
...
void ana_delphes_2000::Init(TTree *tree)
{
...
Bool_t ana_delphes_2000::Notify()
{
...
void ana_delphes_2000::Show(Long64_t entry)
{
...
Int_t ana_delphes_2000::Cut(Long64_t entry)
{
...
#endif // #ifdef ana_delphes_2000_cxx
