...
// Fri Feb 12 15:00:05 2016 by ROOT version 5.34/32
// from TTree LHEF/Analysis tree
// found on file: ../Events/run_ihtmin_20k_1000/tag_1_pythia_lhe_events.root
//////////////////////////////////////////////////////////

#ifndef ana_pythia_1000_h
#define ana_pythia_1000_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   const Int_t kMaxParticle = 31;

const int ihtmin=1000;
const char* INPUT=Form("../Events/run_ihtmin_20k_%d/tag_1_pythia_lhe_events.root",ihtmin);
const char* OUTPUT=Form("skimmed_iht/result_pptt_pythia_ihtmin_%d.root",ihtmin);

class ana_pythia_1000 {
public :
   ...
   ana_pythia_1000(TTree *tree=0);
   virtual ~ana_pythia_1000();
...
#ifdef ana_pythia_1000_cxx
ana_pythia_1000::ana_pythia_1000(TTree *tree) : fChain(0) 
{
...
ana_pythia_1000::~ana_pythia_1000()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ana_pythia_1000::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ana_pythia_1000::LoadTree(Long64_t entry)
{
...
void ana_pythia_1000::Init(TTree *tree)
{
...
void ana_pythia_1000::Show(Long64_t entry)
{
...
Int_t ana_pythia_1000::Cut(Long64_t entry)
{
...
#endif // #ifdef ana_pythia_1000_cxx
