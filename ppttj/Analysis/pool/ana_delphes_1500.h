...
// Fri Feb 12 11:33:03 2016 by ROOT version 5.34/32
// from TTree Delphes/Analysis tree
// found on file: ../Events/run_ihtmin_20k_1500/tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef ana_delphes_1500_h
#define ana_delphes_1500_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   const Int_t kMaxParticle = 1616;
   const Int_t kMaxTrack = 260;
   const Int_t kMaxTower = 335;
   const Int_t kMaxEFlowTrack = 260;
   const Int_t kMaxEFlowPhoton = 194;
   const Int_t kMaxEFlowNeutralHadron = 109;
...
const int ihtmin=1500;
const char* INPUT=Form("../Events/run_ihtmin_20k_%d/tag_1_delphes_events.root",ihtmin);
const char* OUTPUT=Form("skimmed_iht/result_pptt_delphes_ihtmin_%d.root",ihtmin);

class ana_delphes_1500 {
public :
   ...
   ana_delphes_1500(TTree *tree=0);
   virtual ~ana_delphes_1500();
...
#ifdef ana_delphes_1500_cxx
ana_delphes_1500::ana_delphes_1500(TTree *tree) : fChain(0) 
{
...
ana_delphes_1500::~ana_delphes_1500()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ana_delphes_1500::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ana_delphes_1500::LoadTree(Long64_t entry)
{
...
void ana_delphes_1500::Init(TTree *tree)
{
...
Bool_t ana_delphes_1500::Notify()
{
...
void ana_delphes_1500::Show(Long64_t entry)
{
...
Int_t ana_delphes_1500::Cut(Long64_t entry)
{
...
#endif // #ifdef ana_delphes_1500_cxx
