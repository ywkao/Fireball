...
// Fri Feb 12 14:57:59 2016 by ROOT version 5.34/32
// from TTree LHEF/Analysis tree
// found on file: ../Events/run_ihtmin_20k_500/tag_1_pythia_lhe_events.root
//////////////////////////////////////////////////////////

#ifndef ana_pythia_500_h
#define ana_pythia_500_h
...
public :
   ...
   ana_pythia_500(TTree *tree=0);
   virtual ~ana_pythia_500();
...
#ifdef ana_pythia_500_cxx
ana_pythia_500::ana_pythia_500(TTree *tree) : fChain(0) 
{
...
ana_pythia_500::~ana_pythia_500()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ana_pythia_500::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ana_pythia_500::LoadTree(Long64_t entry)
{
...
void ana_pythia_500::Init(TTree *tree)
{
...
void ana_pythia_500::Show(Long64_t entry)
{
...
Int_t ana_pythia_500::Cut(Long64_t entry)
{
...
#endif // #ifdef ana_pythia_500_cxx
