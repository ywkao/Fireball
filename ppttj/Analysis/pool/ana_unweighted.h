...
// Wed Feb 10 15:36:56 2016 by ROOT version 5.34/32
// from TTree LHEF/Analysis tree
// found on file: Events/run_ihtmin_20k_500/unweighted_events.root
//////////////////////////////////////////////////////////

#ifndef ana_unweighted_h
#define ana_unweighted_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   const Int_t kMaxParticle = 14;

const int ihtmin=2500;
const char* INPUT=Form("../Events/run_ihtmin_40k_%d/unweighted_events.root",ihtmin);
const char* OUTPUT=Form("skimmed_iht/result_pptt_unweighted_ihtmin_%d.root",ihtmin);

class ana_unweighted {
public :
   ...
   ana_unweighted(TTree *tree=0);
   virtual ~ana_unweighted();
...
#ifdef ana_unweighted_cxx
ana_unweighted::ana_unweighted(TTree *tree) : fChain(0) 
{
...
ana_unweighted::~ana_unweighted()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ana_unweighted::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ana_unweighted::LoadTree(Long64_t entry)
{
...
void ana_unweighted::Init(TTree *tree)
{
...
void ana_unweighted::Show(Long64_t entry)
{
...
Int_t ana_unweighted::Cut(Long64_t entry)
{
...
#endif // #ifdef ana_unweighted_cxx
