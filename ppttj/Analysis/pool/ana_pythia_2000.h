...
// Fri Feb 12 15:00:28 2016 by ROOT version 5.34/32
// from TTree LHEF/Analysis tree
// found on file: ../Events/run_ihtmin_20k_2000/tag_1_pythia_lhe_events.root
//////////////////////////////////////////////////////////

#ifndef ana_pythia_2000_h
#define ana_pythia_2000_h
...
public :
   ...
   ana_pythia_2000(TTree *tree=0);
   virtual ~ana_pythia_2000();
...
#ifdef ana_pythia_2000_cxx
ana_pythia_2000::ana_pythia_2000(TTree *tree) : fChain(0) 
{
...
ana_pythia_2000::~ana_pythia_2000()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ana_pythia_2000::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ana_pythia_2000::LoadTree(Long64_t entry)
{
...
void ana_pythia_2000::Init(TTree *tree)
{
...
void ana_pythia_2000::Show(Long64_t entry)
{
...
Int_t ana_pythia_2000::Cut(Long64_t entry)
{
...
#endif // #ifdef ana_pythia_2000_cxx
