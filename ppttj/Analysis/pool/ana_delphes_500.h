...
// Fri Feb 12 11:32:24 2016 by ROOT version 5.34/32
// from TTree Delphes/Analysis tree
// found on file: ../Events/run_ihtmin_20k_500/tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef ana_delphes_500_h
#define ana_delphes_500_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   const Int_t kMaxParticle = 1185;
   const Int_t kMaxTrack = 176;
   const Int_t kMaxTower = 246;
   const Int_t kMaxEFlowTrack = 176;
   const Int_t kMaxEFlowPhoton = 142;
...
public :
   ...
   ana_delphes_500(TTree *tree=0);
   virtual ~ana_delphes_500();
...
#ifdef ana_delphes_500_cxx
ana_delphes_500::ana_delphes_500(TTree *tree) : fChain(0) 
{
...
ana_delphes_500::~ana_delphes_500()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ana_delphes_500::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ana_delphes_500::LoadTree(Long64_t entry)
{
...
void ana_delphes_500::Init(TTree *tree)
{
...
void ana_delphes_500::Show(Long64_t entry)
{
...
Int_t ana_delphes_500::Cut(Long64_t entry)
{
...
#endif // #ifdef ana_delphes_500_cxx
